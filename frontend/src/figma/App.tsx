    ...
    <div className="page-ambient flex-1 overflow-y-auto">
      ...
      <div className="px-8 py-7">
        ...
        {filtered.length === 0
          ...
          : <div className="bg-white border border-[#E8E6E1] rounded-xl overflow-hidden">
              <div className={`grid text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wide px-6 py-3 border-b border-[#F0EEE9] bg-[#FAFAF9] ${deleteMode ? 'grid-cols-[32px_1fr_100px_140px_160px_32px]' : 'grid-cols-[1fr_100px_140px_160px_32px]'}`}>
                {deleteMode && <span />}
                ...
                return (
                  <div key={email.id}
                    ...
                    className={`email-row-micro w-full grid items-center px-6 py-4 cursor-pointer group transition-all ${
                      deleteMode ? 'grid-cols-[32px_1fr_100px_140px_160px_32px]' : 'grid-cols-[1fr_100px_140px_160px_32px]'
